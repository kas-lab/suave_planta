...
def generate_launch_description():
    ...
    suave_domain_path = os.path.join(
        suave_pddl_path,
        'suave_domain_extended.pddl'
    )
    suave_domain_out_path = os.path.join(
        suave_pddl_path,
        'suave_domain_extended_created.pddl'
    )
    suave_problem_path = os.path.join(
        suave_pddl_path,
        'suave_problem_extended.pddl'
    )
    suave_problem_out_path = os.path.join(
        suave_pddl_path,
        'suave_problem_extended_created.pddl'
    )
    ...
    recharge_battery_pddl_action_node = Node(
        package='suave_planta',
        executable='action_recharge',
        name='recharge_battery_pddl_action_node',
        parameters=[{'action_name': 'recharge_battery'}]
    )
    ...
    return LaunchDescription([
        ...
        recharge_battery_pddl_action_node,
